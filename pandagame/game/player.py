...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, left, bottom, dir_images):
        ...
        self.images = (
            pygame.image.load( os.path.join(dir_images, 'panda.png') ),
            pygame.image.load( os.path.join(dir_images, 'corre.png') ),
            pygame.image.load( os.path.join(dir_images, 'salto.png') )
